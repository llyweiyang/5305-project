...
trainedClassifier = fitcknn(featuresPca,labels, ...
    Distance="euclidean", ...
    NumNeighbors=5, ...
...
featuresPcaTest = features * coeff(:, 1:numComponentsToKeep);
prediction = predict(trainedClassifier,featuresPcaTest);
